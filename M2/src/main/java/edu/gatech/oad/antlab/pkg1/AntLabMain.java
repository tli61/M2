 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Steven Thomas");
		  toPrint += p1.toString("sthomas85");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Max Kim");
		  toPrint += p2.toString("mkim394");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Nick Pappas");
		  toPrint += p3.toString("npappas3");
          //Person4 replace P4 with your name
          //and gburdell4 with your gt id
          Person4 p4 = new Person4("Tsz Li");
          toPrint += p4.toString("tli61");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Yuh Wang");
                  toPrint += p5.toString("ywang477");
